...
/*! Enables AES128 encrytpion with static initialization vector.
    Overwrites the makro from wmbus_tpl_api.h */
#define AES128_STATIC_IV_ENCRYPT_ENABLED        TRUE

/*! Enables AES128 decryption with static initialization vector.
    Overwrites the makro from wmbus_tpl_api.h */
#define AES128_STATIC_IV_DECRYPT_ENABLED        TRUE
...
#define APL_IGNORE_UNENCRYPTED_COLLECTOR_COMMANDS FALSE
...
/*! Enables the DSMR V.2.2+ extensions.
    There is no makro from wmbus_api.h at the moment */
#define DSMR_V22_PLUS_ENABLED                   TRUE
