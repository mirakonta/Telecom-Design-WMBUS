...
/**
  @file       sf_hal_uartUsb.c
  @copyright  STACKFORCE GmbH, Heitersheim, Germany, http://www.stackforce.de
  @author     STACKFORCE
  @brief      HAL for UART USB implementations.
  
  @addtogroup WMBUS_HAL_UART
  
  Many of the EFM32 devices do have common UART-USB interface. There is a
  driver prepared for using UART-USB for serial communication with the stack
  included: `/src/target/`sf_hal_uartUsb.c
