...
*/
/*============================================================================*/
STZ_INLINE uint16_t* wmbus_config_getMode( void )
{
...
*/
/*============================================================================*/
STZ_INLINE uint16_t* wmbus_config_getDevice( void )
{
  s_wmbus_cfg_ctx_t* pui_cfg = 0;
...
*/
/*============================================================================*/
STZ_INLINE uint16_t* wmbus_config_getCodec( void )
{
  s_wmbus_cfg_ctx_t* pui_cfg = 0;
...
*/
/*============================================================================*/
STZ_INLINE uint16_t* wmbus_config_getChiprate( void )
{
  s_wmbus_cfg_ctx_t* pui_cfg = 0;
