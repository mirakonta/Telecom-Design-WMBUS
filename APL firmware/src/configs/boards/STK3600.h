/*============================================================================*/
/**
 * @file       EFM32LG_STK3600.h
 * @copyright  STACKFORCE GmbH, Heitersheim, Germany, http://www.stackforce.de
 * @author     STACKFORCE
 * @brief      Pre-include configurations for the development kit EFM32LG_STK3600
 *
 */
/*============================================================================*/
/* this define is needed by the EFM library */
#define EFM32LG990F256

#define RF_GPIO0_PORT                    gpioPortC    /* Port A = 0, Port B = 1, Port C = 2, ... */
#define RF_GPIO0_PIN                     (4U)
#define RF_GPIO1_PORT                    gpioPortC    /* Port A = 0, Port B = 1, Port C = 2, ... */
#define RF_GPIO1_PIN                     (5U)
#define RF_SDN_PORT                      gpioPortC    /* Port A = 0, Port B = 1, Port C = 2, ... */
#define RF_SDN_PIN                       (3U)

/* MCU */
#define MCU_SPEED                        (5U)        /* MCU_SPEED_28_MHZ */
